...
void testLabActivity();
void testLabActivity() {
    Bag b;
    assert(b.minimumFrequency() == 0);
    assert(b.elementsWithMinimumFrequency() == 0);
    b.add(5);
    b.add(5);
    b.add(5);
    b.add(10);
...
{
    testLabActivity();
    cout << "Test Lab Activity has passed!\n";
    testAll();
    cout << "Short test has passed!\n";
    testCreate();
    cout << "Good create!\n";
    testAdd();
    cout << "Good add!\n";
